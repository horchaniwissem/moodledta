...
/**
 * Strings for component 'format_tiles', language 'fr', version '3.10'.
 *
...
$string['allcoursescomplypalette'] = 'Tous les cours ont déjà des couleurs de carreaux autorisées. Rien à réinitialiser. Assurez-vous d\'enregistrer toutes les modifications apportées aux couleurs autorisées avant d\'appuyer sur la réinitialisation.';
...
$string['allowphototiles_desc'] = 'Si cette option est sélectionnée, les enseignants pourront télécharger une photo qui servira de fond pour la tuile. Ils pourront toujours utiliser les icônes de tuiles standard, dans le même cours. (Si elle n\'est pas sélectionnée, seules les icônes de tuiles seront autorisées et les autres paramètres de vignette photo ci-dessous seront ignorés.)';
...
$string['dataprefquestion'] = '<p> Pour faciliter l\'utilisation de ce site, nous stockons des informations fonctionnelles dans votre navigateur telles que le contenu de la dernière vignette que vous avez ouverte. Cela reste sur votre ordinateur pendant un court moment au cas où vous visiteriez à nouveau cette page. Nous ne l\'utilisons pas pour le suivi. Êtes-vous d\'accord? </p> <p> Nous nous souviendrons de votre choix jusqu\'à ce que vous effaciez votre historique de navigation. Pour vous désinscrire, cliquez sur "Annuler" (cela peut ralentir le chargement des pages). </p>';
...
$string['documentationurl_descr'] = 'URL où se trouve la documentation concernant les tuiles.';
...
$string['imagesavedfor'] = 'Image enregistrée pour la vignette {$a}';
...
<p> Les photos au format portrait ne correspondront pas à la forme de la vignette. Les images ou fichiers volumineux seront réduits et compressés si nécessaire, après le téléchargement.</p>';
...
$string['phototilesaltstyle_desc'] = 'Si elles ne sont pas sélectionnées (ce qui est la valeur par défaut), les tuiles photo afficheront le titre en haut de la vignette. Le style alternatif montre le titre en bas';
...
$string['registeremailyes'] = 'Oui, je suis prêt à recevoir des notifications de mise à jour occasionnelles et d\'autres informations sur le plugin Tuiles';
...
$string['showoverallprogress_desc'] = 'Afficher l\'indicateur « % de progression globale » en haut à droite du cours (la valeur affichée représente le total du % achevé de chaque vignette, en fonction de l\'achèvement de l\'activité et non de l\'achèvement du cours';
...
$string['tilesformatregistration'] = 'Enregistrement du format des tuiles';
...
$string['usejseditingexpandcollapse_desc'] = 'Si cette option est sélectionnée, en mode édition, un enseignant peut développer et réduire les tuiles d\'édition avec des transitions animées. Le contenu de la vignette sera chargé lors de l\'expansion, sans rechargement de page.';
