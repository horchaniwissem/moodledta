...
/**
 * Strings for component 'error', language 'fr', version '3.10'.
 *
 * @package     error
 * @category    string
...
$string['movecatcontentstoselected'] = 'Certains contenus de la catégorie ne peuvent pas être déplacés dans la catégories choisie.';
