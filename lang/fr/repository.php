...
/**
 * Strings for component 'repository', language 'fr', version '3.10'.
 *
 * @package     repository
 * @category    string
...
$string['aliaseschange'] = 'Il y a {$a} alias qui utilisent ce fichier comme source. Si vous continuez, ce ou ces alias seront convertis en copies du fichier.';
